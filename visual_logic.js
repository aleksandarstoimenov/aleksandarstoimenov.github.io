...
var animations_except_garden, furniture_triggers, room_animation_triggers, zoomed_in, room_animation_duration, rooms_disapearing_duration, camera_animation_duration, What_is_the_current_camera_, Which_animation_to_play___all_rooms___the_current_one_, Is_there_a_wall___zoom_out_, object_clicked, paragraph_text, Which_megamenu_trigger___object_, Which_arrow_to_go_back_, Which_room_trigger_, Which_megamenu_trigger_, Which_animation_to_play___all_the_rooms___current_one_, Which_room_does_the_camera_look_to_, Empty_to_move_the_camera_to_, Camera_selector_zoom_in, Is_there_a_wall___zoom_in_, Which_room_to_reverse_hover_animation_, Pop_Up_for_specific_room, Which_room_is_hoovered_, Which_room_to_trigger_hoover_animation_, Outline_trigger_, Outline_object_, animations_except_study_room, room_animation_frame, animations_except_living_room, animations_except_boiler_room, current_camera, animations_except_entrance, animations_except_kitchen, animations_except_bedroom, animations_except_bathroom, animations_except_toilet;
...
function Hide_all_the_pop_up_elements() {
  ...
  setHTMLElemStyle('display', 'none', 'study-room-text', true);
...
Update_the_text_in_the_Pop_up('electricity_living_room_trigger', ('          <h1 id="popup_object">Plafonnier, prise de courant, interrupteur.</h1>' + '\n' +
'          <div id="dividing_line_2"></div>' + '\n' +
'          <p id="popup_locataire">Locataire</p>' + '\n' +
...
Zoom_to_clicked_room('living_room_trigger', 'megamenu_living_room', animations_except_living_room, 'camera_target_living_room', 'camera_position_living_room', 'living', null, ['GROUP', 'living_room'], 'living-room-text');
Zoom_to_clicked_room('entrance_trigger', 'megamenu_entrance', animations_except_entrance, 'camera_target_entrance', 'camera_position_entrance', 'entrance', 'trigger_entrance_wall_animation', ['GROUP', 'entrance'], 'entrance-text');
Zoom_to_clicked_room('kitchen_trigger', 'megamenu_kitchen', animations_except_kitchen, 'camera_target_kitchen', 'camera_position_kitchen', 'kitchen', 'trigger_kitchen_wall_animation', ['GROUP', 'kitchen'], 'kitchen-text');
Zoom_to_clicked_room('bathroom_trigger', 'megamenu_bathroom', animations_except_bathroom, 'camera_target_bathroom', 'camera_position_bathroom', 'bathroom', null, ['GROUP', 'bathroom'], 'bathroom-text');
Zoom_to_clicked_room('boiler_room_trigger', 'megamenu_boiler_room', animations_except_boiler_room, 'camera_target_boiler_room', 'camera_position_boiler_room', 'boiler', null, ['GROUP', 'boiler_room'], 'boiler-room-text');
Zoom_to_clicked_room('bedroom_trigger', 'megamenu_bedroom', animations_except_bedroom, 'camera_target_bedroom', 'camera_position_bedroom', 'bedroom', null, ['GROUP', 'bedroom'], 'bedroom-text');
Zoom_to_clicked_room('toilet_trigger', 'megamenu_toilet', animations_except_toilet, 'camera_target_toilet', 'camera_position_toilet', 'toilet', null, ['GROUP', 'toilet'], 'toilet-text');
Zoom_to_clicked_room('garden_trigger', 'megamenu_garden', animations_except_garden, 'camera_target_garden', 'camera_position_garden', 'garden', null, ['GROUP', 'garden'], 'garden-text');
Zoom_to_clicked_room('study_room_trigger', 'megamenu_study_room', animations_except_study_room, 'camera_target_study_room', 'camera_position_study_room', 'study_room', 'trigger_study_room_animation', ['GROUP', 'study_room'], 'study-room-text');

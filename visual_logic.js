...
function Update_the_text_in_the_Pop_up(object_clicked, paragraph_text, Which_megamenu_trigger___object_, Which_arrow_to_go_back_) {
  ...
  registerOnClick(object_clicked, false, false, [0,1,2], function() {
    ...
    setHTMLElemStyle('transform', 'translate(0%, -50%)', 'text-block', true);
...
function Play_zoom_out_animation(What_is_the_current_camera_, Which_animation_to_play___all_rooms___the_current_one_, Is_there_a_wall___zoom_out_) {
  registerOnClick('background_sphere', false, false, [0,1,2], function() {
    if (zoomed_in == true && current_camera == What_is_the_current_camera_) {
      ...
      setCameraParam('ORBIT_MAX_DISTANCE_PERSP', 'camera', 200);
...
setCameraParam('ORBIT_MIN_DISTANCE_PERSP', 'camera', 150);
...
setCameraParam('ORBIT_MAX_HORIZONTAL_ANGLE', 'camera', 70);
...
'          <p id="popup_paragraph"><span id="color_overwrite">•</span> Tous remplacements.</p>'), 'megamenu_living_room_radiator', 'back_arrow_living_room_popup');
...
'          <div id="dividing_line_2"></div>' + '\n' +
'          <p id="popup_locataire">Propriétaire</p>' + '\n' +
'          <p id="popup_paragraph"><span id="color_overwrite">•</span> Tous remplacements des câblages pour tous services sauf si causés par des modifications du locataire. </p>'), 'megamenu_living_room_electricity', 'back_arrow_living_room_popup');
...
'          <div id="dividing_line_2"></div>' + '\n' +
'          <p id="popup_locataire">Propriétaire</p>' + '\n' +
'          <p id="popup_paragraph"><span id="color_overwrite">•</span> Réparations nécessaires, autres que locatives, et remplacement.</p>'), 'megamenu_living_room_window', 'back_arrow_living_room_popup');
...
'          <div id="dividing_line_2"></div>' + '\n' +
'          <p id="popup_locataire">Propriétaire</p>' + '\n' +
'          <p id="popup_paragraph"><span id="color_overwrite">•</span> Réparations nécessaires, autres que locatives, et remplacement.</p>'), 'megamenu_living_room_fireplace', 'back_arrow_living_room_popup');
...
'          <div id="dividing_line_2"></div>' + '\n' +
'          <p id="popup_locataire">Propriétaire</p>' + '\n' +
'          <p id="popup_paragraph"><span id="color_overwrite">•</span> Réparations nécessaires, autres que locatives, et remplacement.</p>'), 'megamenu_living_room_ventilation_opening', 'back_arrow_living_room_popup');
...
'          <div id="dividing_line_2"></div>' + '\n' +
'          <p id="popup_locataire">Propriétaire</p>' + '\n' +
'          <p id="popup_paragraph"><span id="color_overwrite">•</span> Tous remplacements.</p>'), 'megamenu_kitchen_radiator', 'back_arrow_kitchen_popup');
...
'          <div id="dividing_line_2"></div>' + '\n' +
'          <p id="popup_locataire">Propriétaire</p>' + '\n' +
'          <p id="popup_paragraph"><span id="color_overwrite">•</span> Réparations nécessaires, autres que locatives, et remplacement.</p>'), 'megamenu_kitchen_ventilation_opening', 'back_arrow_kitchen_popup');
...
Zoom_to_clicked_room('attic_room_trigger', 'megamenu_attic_room', [animations_except_attic_room, ['GROUP', 'moving_walls']], 'camera_target_attic_room', 'camera_position_attic_room', 'attic_room', null, ['GROUP', 'attic_room'], 'attic-room-text');
Zoom_to_clicked_room('bathroom_trigger', 'megamenu_bathroom', [animations_except_bathroom, ['GROUP', 'moving_walls'], ['GROUP', 'attic_roof_exception']], 'camera_target_bathroom', 'camera_position_bathroom', 'bathroom', null, ['GROUP', 'bathroom'], 'bathroom-text');
Zoom_to_clicked_room('toilet_trigger', 'megamenu_toilet', [animations_except_toilet, ['GROUP', 'attic_roof_exception'], ['GROUP', 'moving_walls']], 'camera_target_toilet', 'camera_position_toilet', 'toilet', null, ['GROUP', 'toilet'], 'toilet-text');
Zoom_to_clicked_room('bedroom_trigger', 'megamenu_bedroom', [animations_except_bedroom, ['GROUP', 'attic_roof_exception'], ['GROUP', 'moving_walls']], 'camera_target_bedroom', 'camera_position_bedroom', 'bedroom', null, ['GROUP', 'bedroom'], 'bedroom-text');
Zoom_to_clicked_room('entrance_trigger', 'megamenu_entrance', [['GROUP', 'attic_roof_exception'], animations_except_entrance, ['GROUP', 'moving_walls']], 'camera_target_entrance', 'camera_position_entrance', 'entrance', null, ['GROUP', 'entrance'], 'entrance-text');
Zoom_to_clicked_room('living_room_trigger', 'megamenu_living_room', [['GROUP', 'attic_roof_exception'], animations_except_living_room, ['GROUP', 'moving_walls']], 'camera_target_living_room', 'camera_position_living_room', 'living', null, ['GROUP', 'living_room'], 'living-room-text');
Zoom_to_clicked_room('kitchen_trigger', 'megamenu_kitchen', [['GROUP', 'attic_roof_exception'], animations_except_kitchen, ['GROUP', 'moving_walls']], 'camera_target_kitchen', 'camera_position_kitchen', 'kitchen', null, ['GROUP', 'kitchen'], 'kitchen-text');
Zoom_to_clicked_room('boiler_room_trigger', 'megamenu_boiler_room', [['GROUP', 'attic_roof_exception'], animations_except_boiler_room, ['GROUP', 'moving_walls']], 'camera_target_boiler_room', 'camera_position_boiler_room', 'boiler', null, ['GROUP', 'boiler_room'], 'boiler-room-text');
Zoom_to_clicked_room('laundry_room_trigger', 'megamenu_laundry_room', [['GROUP', 'attic_roof_exception'], animations_except_laundry_room, ['GROUP', 'moving_walls']], 'camera_target_laundry_room', 'camera_position_laundry_room', 'laundry_room', null, ['GROUP', 'laundry_room'], 'laundry-room-text');
Zoom_to_clicked_room('garden_trigger', 'megamenu_garden', [['GROUP', 'attic_roof_exception'], animations_except_garden, ['GROUP', 'moving_walls']], 'camera_target_garden', 'camera_position_garden', 'garden', null, ['GROUP', 'garden'], 'garden-text');

...
// Describe this function...
function Turn_object_red_when_hovered(Trigger_object_to_turn_red, Group_object_to_turn_red, Which_menu_trigger_for_red_hover_) {
...
Turn_object_red_when_hovered('radiator_living_room_trigger', ['GROUP', 'radiator_living_room'], 'megamenu_living_room_radiator');
Turn_object_red_when_hovered('plug_living_room_trigger', ['GROUP', 'plug_living_room'], 'megamenu_living_room_electricity');
Turn_object_red_when_hovered('fireplace_living_room_trigger', ['GROUP', 'fireplace_living_room'], 'megamenu_living_room_fireplace');
Turn_object_red_when_hovered('ventilation_opening_living_room_trigger', ['GROUP', 'ventilation_opening_living_room'], 'megamenu_living_room_ventilation_opening');
...
Turn_object_red_when_hovered('fridge_kitchen_trigger', ['GROUP', 'fridge_kitchen'], null);
Turn_object_red_when_hovered('wall_covering_kitchen_trigger', ['GROUP', 'wall_covering_kitchen'], null);
Turn_object_red_when_hovered('radiator_kitchen_trigger', ['GROUP', 'radiator_kitchen'], null);
Turn_object_red_when_hovered('sink_kitchen_trigger', ['GROUP', 'sink_kitchen'], null);
Turn_object_red_when_hovered('stove_kitchen_trigger', ['GROUP', 'stove_kitchen'], null);
Turn_object_red_when_hovered('stove_kitchen_trigger', ['GROUP', 'stove_kitchen'], null);
Turn_object_red_when_hovered('vermin_kitchen_trigger', ['GROUP', 'vermin_kitchen'], null);
Turn_object_red_when_hovered('extractor_hoof_kitchen_trigger', ['GROUP', 'extractor_hood_kitchen'], null);
Turn_object_red_when_hovered('plug_kitchen_trigger', ['GROUP', 'plug_kitchen'], null);
Turn_object_red_when_hovered('switch_kitchen_trigger', ['GROUP', 'switch_kitchen'], null);
Turn_object_red_when_hovered('ceiling_light_kitchen_trigger', ['GROUP', 'ceiling_light_kitchen'], null);
Turn_object_red_when_hovered('gas_heater_kitchen_trigger', ['GROUP', 'gas_heater_kitchen'], null);
Turn_object_red_when_hovered('interior_door_kitchen_trigger', ['GROUP', 'interior_door_kitchen'], null);

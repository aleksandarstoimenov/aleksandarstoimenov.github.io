...
var animations_except_attic_room, furniture_triggers, Which_room_trigger_, Which_megamenu_trigger_, Which_animation_to_play___all_the_rooms___current_one_, Which_room_does_the_camera_look_to_, Empty_to_move_the_camera_to_, Camera_selector_zoom_in, Is_there_a_wall___zoom_in_, Which_room_to_reverse_hover_animation_, Pop_Up_for_specific_room, Which_room_to_trigger_hoover_animation_, allow_background_click, Trigger_object_to_turn_red, Group_object_to_turn_red, Which_menu_trigger_for_red_hover_, paragraph_text, Which_arrow_to_go_back_, What_is_the_current_camera_, Which_animation_to_play___all_rooms___the_current_one_, Is_there_a_wall___zoom_out_, zoomed_in, Which_room_is_hoovered_, Which_html_element_is_hovered_, animations_except_bathroom, room_animation_triggers, room_animation_frame, room_animation_duration, This_is_the_previously_clicked_object, animations_except_toilet, current_camera, rooms_disapearing_duration, animations_except_bedroom, camera_animation_duration, animations_except_entrance, Which_trigger_object_has_been_clicked__, animations_except_living_room, animations_except_kitchen, animations_except_boiler_room, animations_except_laundry_room, animations_except_garden;
...
function Play_zoom_out_animation(What_is_the_current_camera_, Which_animation_to_play___all_rooms___the_current_one_, Is_there_a_wall___zoom_out_) {
  ...
  } else if (featureAvailable('MOBILE') == false) {
...
Turn_object_red_when_hovered('roof_attic_room_trigger', ['GROUP', 'roof_attic_room'], 'megamenu_attic_room_roof', ('<h1 id="popup_object">Test</h1>' + '\n' +
'<div id="dividing_line_header"></div>' + '\n' +
'<p id="popup_locataire">Locataire</p>' + '\n' +
'<ul id="popup_paragraph">' + '\n' +
'    <li>Nettoyage des bouches qui doivent rester ouvertes en permanence.</li>' + '\n' +
...
'    <li>Réparations nécessaires, autres que locatives, et remplacement.</li>' + '\n' +
'</ul>'), 'back_arrow_attic_room_popup');
Turn_object_red_when_hovered('window_attic_room_trigger', ['GROUP', 'window_attic_room'], 'megamenu_attic_room_window', ('<h1 id="popup_object">Test</h1>' + '\n' +
'<div id="dividing_line_header"></div>' + '\n' +
'<p id="popup_locataire">Locataire</p>' + '\n' +
'<ul id="popup_paragraph">' + '\n' +
'    <li>Nettoyage des bouches qui doivent rester ouvertes en permanence.</li>' + '\n' +
...
'    <li>Réparations nécessaires, autres que locatives, et remplacement.</li>' + '\n' +
'</ul>'), 'back_arrow_attic_room_popup');
Turn_object_red_when_hovered('flooring_attic_room_trigger', ['GROUP', 'flooring_attic_room'], 'megamenu_attic_room_flooring', ('<h1 id="popup_object">Test</h1>' + '\n' +
'<div id="dividing_line_header"></div>' + '\n' +
'<p id="popup_locataire">Locataire</p>' + '\n' +
'<ul id="popup_paragraph">' + '\n' +
'    <li>Nettoyage des bouches qui doivent rester ouvertes en permanence.</li>' + '\n' +
...
'    <li>Réparations nécessaires, autres que locatives, et remplacement.</li>' + '\n' +
'</ul>'), 'back_arrow_attic_room_popup');
Turn_object_red_when_hovered('gutter_attic_room_trigger', ['GROUP', 'gutter_attic_room'], 'megamenu_attic_room_gutter', ('<h1 id="popup_object">Test</h1>' + '\n' +
'<div id="dividing_line_header"></div>' + '\n' +
'<p id="popup_locataire">Locataire</p>' + '\n' +
'<ul id="popup_paragraph">' + '\n' +
'    <li>Nettoyage des bouches qui doivent rester ouvertes en permanence.</li>' + '\n' +
...
'    <li>Réparations nécessaires, autres que locatives, et remplacement.</li>' + '\n' +
'</ul>'), 'back_arrow_bathroom_popup');
Turn_object_red_when_hovered('wall_covering_bathroom_trigger', ['GROUP', 'wall_covering_bathroom'], 'megamenu_bathroom_wall_covering', ('<h1 id="popup_object">Test</h1>' + '\n' +
'<div id="dividing_line_header"></div>' + '\n' +
'<p id="popup_locataire">Locataire</p>' + '\n' +
'<ul id="popup_paragraph">' + '\n' +
'    <li>Nettoyage des bouches qui doivent rester ouvertes en permanence.</li>' + '\n' +
...
'    <li>Réparations nécessaires, autres que locatives, et remplacement.</li>' + '\n' +
'</ul>'), 'back_arrow_bathroom_popup');
Turn_object_red_when_hovered('flooring_bathroom_trigger', ['GROUP', 'flooring_bathroom'], 'megamenu_bathroom_flooring', ('<h1 id="popup_object">Test</h1>' + '\n' +
'<div id="dividing_line_header"></div>' + '\n' +
'<p id="popup_locataire">Locataire</p>' + '\n' +
'<ul id="popup_paragraph">' + '\n' +
'    <li>Nettoyage des bouches qui doivent rester ouvertes en permanence.</li>' + '\n' +
...
'    <li>Réparations nécessaires, autres que locatives, et remplacement.</li>' + '\n' +
'</ul>'), 'back_arrow_toilet_popup');
Turn_object_red_when_hovered('flooring_toilet_trigger', ['GROUP', 'flooring_toilet'], 'megamenu_toilet_flooring', ('<h1 id="popup_object">Test</h1>' + '\n' +
'<div id="dividing_line_header"></div>' + '\n' +
'<p id="popup_locataire">Locataire</p>' + '\n' +
'<ul id="popup_paragraph">' + '\n' +
'    <li>Nettoyage des bouches qui doivent rester ouvertes en permanence.</li>' + '\n' +
...
Turn_object_red_when_hovered('curtains_bedroom_trigger', ['GROUP', 'curtains_bedroom'], 'megamenu_bedroom_shutters', ('<h1 id="popup_object">Test</h1>' + '\n' +
'<div id="dividing_line_header"></div>' + '\n' +
'<p id="popup_locataire">Locataire</p>' + '\n' +
'<ul id="popup_paragraph">' + '\n' +
'    <li>Nettoyage des bouches qui doivent rester ouvertes en permanence.</li>' + '\n' +
...
'    <li>Réparations nécessaires, autres que locatives, et remplacement.</li>' + '\n' +
'</ul>'), 'back_arrow_bedroom_popup');
Turn_object_red_when_hovered('flooring_bedroom_trigger', ['GROUP', 'flooring_bedroom'], 'megamenu_bedroom_flooring', ('<h1 id="popup_object">Test</h1>' + '\n' +
'<div id="dividing_line_header"></div>' + '\n' +
'<p id="popup_locataire">Locataire</p>' + '\n' +
'<ul id="popup_paragraph">' + '\n' +
'    <li>Nettoyage des bouches qui doivent rester ouvertes en permanence.</li>' + '\n' +
...
'    <li>Réparations nécessaires, autres que locatives, et remplacement.</li>' + '\n' +
'</ul>'), 'back_arrow_entrance_popup');
Turn_object_red_when_hovered('flooring_entrance_trigger', ['GROUP', 'flooring_entrance'], 'megamenu_entrance_flooring', ('<h1 id="popup_object">Test</h1>' + '\n' +
'<div id="dividing_line_header"></div>' + '\n' +
'<p id="popup_locataire">Locataire</p>' + '\n' +
'<ul id="popup_paragraph">' + '\n' +
'    <li>Nettoyage des bouches qui doivent rester ouvertes en permanence.</li>' + '\n' +
...
'    <li>Réparations nécessaires, autres que locatives, et remplacement.</li>' + '\n' +
'</ul>'), 'back_arrow_living_room_popup');
Turn_object_red_when_hovered('flooring_living_room_trigger', ['GROUP', 'flooring_living_room'], 'megamenu_living_room_flooring', ('<h1 id="popup_object">Test</h1>' + '\n' +
'<div id="dividing_line_header"></div>' + '\n' +
'<p id="popup_locataire">Locataire</p>' + '\n' +
'<ul id="popup_paragraph">' + '\n' +
'    <li>Nettoyage des bouches qui doivent rester ouvertes en permanence.</li>' + '\n' +
...
'    <li>Réparations nécessaires, autres que locatives, et remplacement.</li>' + '\n' +
'</ul>'), 'back_arrow_living_room_popup');
Turn_object_red_when_hovered('wall_covering_living_room_trigger', ['GROUP', 'wall_covering_living_room'], 'megamenu_living_room_wall_covering', ('<h1 id="popup_object">Test</h1>' + '\n' +
'<div id="dividing_line_header"></div>' + '\n' +
'<p id="popup_locataire">Locataire</p>' + '\n' +
'<ul id="popup_paragraph">' + '\n' +
'    <li>Nettoyage des bouches qui doivent rester ouvertes en permanence.</li>' + '\n' +
...
'    <li>Réparations nécessaires, autres que locatives, et remplacement.</li>' + '\n' +
'</ul>'), 'back_arrow_living_room_popup');
Turn_object_red_when_hovered('interior_door_living_room_trigger', ['GROUP', 'interior_door_living_room'], 'megamenu_living_room_wall_covering', ('<h1 id="popup_object">Test</h1>' + '\n' +
'<div id="dividing_line_header"></div>' + '\n' +
'<p id="popup_locataire">Locataire</p>' + '\n' +
'<ul id="popup_paragraph">' + '\n' +
'    <li>Nettoyage des bouches qui doivent rester ouvertes en permanence.</li>' + '\n' +
...
'    <li>Réparations nécessaires, autres que locatives, et remplacement.</li>' + '\n' +
'</ul>'), 'back_arrow_kitchen_popup');
Turn_object_red_when_hovered('flooring_kitchen_trigger', ['GROUP', 'flooring_kitchen'], 'megamenu_kitchen_flooring', ('<h1 id="popup_object">Test</h1>' + '\n' +
'<div id="dividing_line_header"></div>' + '\n' +
'<p id="popup_locataire">Locataire</p>' + '\n' +
'<ul id="popup_paragraph">' + '\n' +
'    <li>Nettoyage des bouches qui doivent rester ouvertes en permanence.</li>' + '\n' +
...
'    <li>Réparations nécessaires, autres que locatives, et remplacement.</li>' + '\n' +
'</ul>'), 'back_arrow_kitchen_popup');
Turn_object_red_when_hovered('faucets_kitchen_trigger', ['GROUP', 'faucets_kitchen'], 'megamenu_kitchen_faucet', ('<h1 id="popup_object">Test</h1>' + '\n' +
'<div id="dividing_line_header"></div>' + '\n' +
'<p id="popup_locataire">Locataire</p>' + '\n' +
'<ul id="popup_paragraph">' + '\n' +
'    <li>Nettoyage des bouches qui doivent rester ouvertes en permanence.</li>' + '\n' +
...
'    <li>Réparations nécessaires, autres que locatives, et remplacement.</li>' + '\n' +
'</ul>'), 'back_arrow_kitchen_popup');
Turn_object_red_when_hovered('exterior_door_kitchen_trigger', ['GROUP', 'exterior_door_kitchen'], 'megamenu_kitchen_exterior_door', ('<h1 id="popup_object">Test</h1>' + '\n' +
'<div id="dividing_line_header"></div>' + '\n' +
'<p id="popup_locataire">Locataire</p>' + '\n' +
'<ul id="popup_paragraph">' + '\n' +
'    <li>Nettoyage des bouches qui doivent rester ouvertes en permanence.</li>' + '\n' +
...
'    <li>Réparations nécessaires, autres que locatives, et remplacement.</li>' + '\n' +
'</ul>'), 'back_arrow_garden_popup');
Turn_object_red_when_hovered('balcony_garden_trigger', ['GROUP', 'balcony_garden'], 'megamenu_garden_balcony', ('<h1 id="popup_object">Test</h1>' + '\n' +
'<div id="dividing_line_header"></div>' + '\n' +
'<p id="popup_locataire">Locataire</p>' + '\n' +
'<ul id="popup_paragraph">' + '\n' +
'    <li>Nettoyage des bouches qui doivent rester ouvertes en permanence.</li>' + '\n' +

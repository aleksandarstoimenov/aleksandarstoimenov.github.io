...
var animations_except_boiler_room, furniture_triggers, room_animation_triggers, Which_room_trigger_, Which_animation_to_play___all_the_rooms___current_one_, Which_room_does_the_camera_look_to_, Empty_to_move_the_camera_to_, Camera_selector_zoom_in, What_is_the_current_camera_, Which_animation_to_play___all_rooms___the_current_one_, object_clicked, paragraph_text, room_animation_duration, rooms_disapearing_duration, zoomed_in, camera_animation_duration, Which_room_is_hoovered_, Which_room_to_trigger_hoover_animation_, animations_except_kitchen, room_animation_frame, animations_except_living_room, animations_except_bedroom, current_camera, animations_except_entrance, animations_except_bathroom, animations_except_toilet;
...
function Zoom_to_clicked_room(Which_room_trigger_, Which_animation_to_play___all_the_rooms___current_one_, Which_room_does_the_camera_look_to_, Empty_to_move_the_camera_to_, Camera_selector_zoom_in) {
  registerOnClick(Which_room_trigger_, false, false, [0,1,2], function() {
    ...
    if (zoomed_in == false) {
      ...
      registerSetTimeout((room_animation_frame + 1) / 24, function() {

        operateAnimation('PLAY', getAnimations(Which_animation_to_play___all_the_rooms___current_one_), 0, rooms_disapearing_duration, 'LoopOnce', 4,
                function() {
          tweenCamera(Empty_to_move_the_camera_to_, Which_room_does_the_camera_look_to_, 0.6, function() {}, 0);
          zoomed_in = true;
...
// Describe this function...
function Play_zoom_out_animation(What_is_the_current_camera_, Which_animation_to_play___all_rooms___the_current_one_) {
  registerOnClick('background', false, false, [0,1,2], function() {
    if (zoomed_in == true && current_camera == What_is_the_current_camera_) {
      ...
      operateAnimation('PLAY', getAnimations(Which_animation_to_play___all_rooms___the_current_one_), 0, rooms_disapearing_duration, 'LoopOnce', 4,
              function() {
...
function Hoover_over_room_animation(Which_room_is_hoovered_, Which_room_to_trigger_hoover_animation_) {
  registerOnHover(Which_room_is_hoovered_, false, function() {
    ...
    operateAnimation('SET_SPEED', getAnimations(Which_room_to_trigger_hoover_animation_), null, null, 'AUTO', 1,
            function() {}, false);


    operateAnimation('PLAY', getAnimations(Which_room_to_trigger_hoover_animation_), 0, room_animation_duration, 'LoopOnce', 1,
            function() {}, false);
...
animations_except_boiler_room = [['GROUP', 'bathroom'], ['GROUP', 'bedroom'], ['GROUP', 'living_room'], ['GROUP', 'kitchen'], ['GROUP', 'entrance'], ['GROUP', 'toilet']];
animations_except_kitchen = [['GROUP', 'bathroom'], ['GROUP', 'bedroom'], ['GROUP', 'boiler_room'], ['GROUP', 'living_room'], ['GROUP', 'entrance'], ['GROUP', 'toilet']];
animations_except_bedroom = [['GROUP', 'bathroom'], ['GROUP', 'living_room'], ['GROUP', 'boiler_room'], ['GROUP', 'kitchen'], ['GROUP', 'entrance'], ['GROUP', 'toilet']];
animations_except_bathroom = [['GROUP', 'living_room'], ['GROUP', 'bedroom'], ['GROUP', 'boiler_room'], ['GROUP', 'kitchen'], ['GROUP', 'entrance'], ['GROUP', 'toilet']];
animations_except_toilet = [['GROUP', 'bathroom'], ['GROUP', 'bedroom'], ['GROUP', 'boiler_room'], ['GROUP', 'kitchen'], ['GROUP', 'entrance'], ['GROUP', 'living_room']];
animations_except_living_room = [['GROUP', 'bathroom'], ['GROUP', 'bedroom'], ['GROUP', 'boiler_room'], ['GROUP', 'kitchen'], ['GROUP', 'entrance'], ['GROUP', 'toilet']];
animations_except_entrance = [['GROUP', 'bathroom'], ['GROUP', 'bedroom'], ['GROUP', 'boiler_room'], ['GROUP', 'kitchen'], ['GROUP', 'living_room'], ['GROUP', 'toilet']];

furniture_triggers = ['cupboard_trigger', 'lamp_trigger', null];

changeVis(getEntityByName(furniture_triggers, 'OBJECT'), false);

room_animation_triggers = ['toilet_trigger', 'bedroom_trigger', 'kitchen_trigger', 'bathroom_trigger', 'entrance_trigger', 'boiler_room_trigger', 'living_room_trigger'];

room_animation_duration = 20;

rooms_disapearing_duration = 70;

eventHTMLElem('click', 'popup-cross', true, function(event) {
  setHTMLElemStyle('transform', 'translate(300%, -50%)', 'text-container', true);
});
...
Update_the_text_in_the_Pop_up('cupboard_trigger', ('          <div class="popup-cross" id="popup-cross"></div>' + '\n' +
'          <h1 id="popup_room">Séjour</h1>' + '\n' +
...
Update_the_text_in_the_Pop_up('lamp_trigger', ('          <div class="popup-cross" id="popup-cross"></div>' + '\n' +
'          <h1 id="popup_room">Séjour</h1>' + '\n' +
...
Play_zoom_out_animation('living', animations_except_living_room);
Play_zoom_out_animation('entrance', animations_except_entrance);
Play_zoom_out_animation('kitchen', animations_except_kitchen);
Play_zoom_out_animation('bathroom', animations_except_bathroom);
Play_zoom_out_animation('boiler', animations_except_boiler_room);
Play_zoom_out_animation('bedroom', animations_except_bedroom);
Play_zoom_out_animation('toilet', animations_except_toilet);

outline('Cylinder', 'ENABLE');

Zoom_to_clicked_room('living_room_trigger', animations_except_living_room, 'camera_target_living_room', 'camera_position_living_room', 'living');
Zoom_to_clicked_room('entrance_trigger', animations_except_entrance, 'camera_target_entrance', 'camera_position_entrance', 'entrance');
Zoom_to_clicked_room('kitchen_trigger', animations_except_kitchen, 'camera_target_kitchen', 'camera_position_kitchen', 'kitchen');
Zoom_to_clicked_room('bathroom_trigger', animations_except_bathroom, 'camera_target_bathroom', 'camera_position_bathroom', 'bathroom');
Zoom_to_clicked_room('boiler_room_trigger', animations_except_boiler_room, 'camera_target_boiler_room', 'camera_position_boiler_room', 'boiler');
Zoom_to_clicked_room('bedroom_trigger', animations_except_bedroom, 'camera_target_bedroom', 'camera_position_bedroom', 'bedroom');
Zoom_to_clicked_room('toilet_trigger', animations_except_toilet, 'camera_target_toilet', 'camera_position_toilet', 'toilet');

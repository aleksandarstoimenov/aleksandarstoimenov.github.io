...
var animations_except_garden, furniture_triggers, room_animation_triggers, Which_room_trigger_, Which_animation_to_play___all_the_rooms___current_one_, Which_room_does_the_camera_look_to_, Empty_to_move_the_camera_to_, Camera_selector_zoom_in, What_is_the_current_camera_, Which_animation_to_play___all_rooms___the_current_one_, object_clicked, paragraph_text, room_animation_duration, rooms_disapearing_duration, zoomed_in, camera_animation_duration, Which_room_is_hoovered_, Which_room_to_trigger_hoover_animation_, animations_except_study_room, room_animation_frame, animations_except_living_room, animations_except_boiler_room, current_camera, animations_except_entrance, animations_except_kitchen, animations_except_bedroom, animations_except_bathroom, animations_except_toilet;
...
function Zoom_to_clicked_room(Which_room_trigger_, Which_animation_to_play___all_the_rooms___current_one_, Which_room_does_the_camera_look_to_, Empty_to_move_the_camera_to_, Camera_selector_zoom_in) {
  registerOnClick(Which_room_trigger_, false, false, [0,1,2], function() {
    ...
    if (zoomed_in == false) {
      ...
      tweenCamera(Empty_to_move_the_camera_to_, Which_room_does_the_camera_look_to_, 0.8, function() {}, 0);
...
registerSetTimeout(((room_animation_frame + 1) / 24) / 2, function() {});
...
Play_zoom_out_animation('garden', animations_except_garden);
Play_zoom_out_animation('study_room', animations_except_study_room);
...
Zoom_to_clicked_room('garden_trigger', animations_except_garden, 'camera_target_garden', 'camera_position_garden', 'garden');
Zoom_to_clicked_room('study_room_trigger', animations_except_study_room, 'camera_target_study_room', 'camera_position_study_room', 'study_room');
